 ...
 *
 * @package EVM_Back_To_Top_Admin
 * @author  Jon Huther <jon@evm.io>
 */
class EVM_Back_To_Top_Admin {
	...
	private function __construct() {
		 ...
		 *
		 */
		$plugin = EVM_Back_To_Top::get_instance();
	...
	public function enqueue_admin_styles() {
		...
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			wp_enqueue_style( $this->plugin_slug .'-admin-styles', plugins_url( 'assets/css/admin.css', __FILE__ ), array(), EVM_Back_To_Top::VERSION );
		}
	...
	public function enqueue_admin_scripts() {
		...
		$screen = get_current_screen();
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			wp_enqueue_script( $this->plugin_slug . '-admin-script', plugins_url( 'assets/js/admin.js', __FILE__ ), array( 'jquery' ), EVM_Back_To_Top::VERSION );
		}
	...
	public function add_plugin_admin_menu() {
		...
		$this->plugin_screen_hook_suffix = add_options_page(
			__( 'EVM Back To Top', $this->plugin_slug ),
			__( 'EVM Back To Top', $this->plugin_slug ),
			'manage_options',
			$this->plugin_slug,
